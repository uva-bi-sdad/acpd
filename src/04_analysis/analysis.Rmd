...
sim <- fread(input = here::here("data", "acpd", "Similarity_Matrix", "raw_similarity_scores_ari.csv")) %>%
  clean_names() %>%
...
dt <- fread(input = here::here("data", "acpd", "Clarendon_details", "clarendon_clean_03.csv")) %>%
  clean_names() %>%
